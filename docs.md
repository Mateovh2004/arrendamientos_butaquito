...
### Resumen del flujo (pantallas principales y transiciones):

- **Pantalla de Login / Registro**
  - Entrada con Firebase Authentication; opción de recuperar contraseña.
  - Tras autenticarse, redirige al Dashboard.

- **Dashboard (Lista de inmuebles / inventarios)**
  - Muestra inmuebles asignados y estado de inventarios (Pendiente, En proceso, Finalizado).

  - Acciones: Crear inventario, Ver inventarios, Buscar inmueble.

- **Seleccionar Inmueble**
  - Vista con datos básicos del inmueble y botón Crear inventario o Continuar inventario existente.

- **Crear / Editar Inventario**
  - Formulario con metadatos (fecha, inventarista, notas generales).

  - Lista de Espacios (añadir/editar/eliminar).

  - Barra inferior con progreso y botón Guardar borrador.

- **Detalle de Espacio**
  - Campos: nombre del espacio, lista de Elementos, botón Agregar novedad, botón Adjuntar foto.

  - Cada elemento puede abrir un modal para editar estado y fotos.

- **Registrar Novedad**
  - Formulario corto: tipo de novedad, descripción, gravedad, fotos asociadas.

  - Validaciones: descripción obligatoria.

- **Galería / Adjuntar Fotografías**
  - Interfaz para tomar foto con la cámara o seleccionar desde la galería.

  - Previsualización y etiquetado (asociar a espacio o novedad).

- **Resumen del Inventario (Revisión antes de finalizar)**
  - Checklist de campos obligatorios; muestra qué falta completar.

  - Botones: Finalizar inventario (solo si completo) y Guardar.

- **Enviar Inventario**
  - Selección de destinatario (propietario, inquilino, asesor).

  - Vista previa del PDF/archivo a enviar; botón Enviar por correo (API Gmail).

  - Confirmación de envío y registro de trazabilidad.

- **Historial / Consultar Inventarios**
  - Filtros por estado, inmueble, fecha, inventarista.

  - Detalle de inventario con fotos, historial de envíos y responsable.

## Propuestas de diseno y mockups

### **Login:** Campo email, contraseña, botón principal.

![Login](assets/stitch_butaquito_inventario_digital/mockups/inicio_de_sesi_n_butaquito_refined/screen.png)

### **Dashboard:** Lista de inmuebles con estado y botón de crear inmueble.

![Dashboard](assets/stitch_butaquito_inventario_digital/mockups/mis_inmuebles_butaquito_es/screen.png)

### **Crear inventario:** Campos principales y botón guardar.

![Crear inventario](assets/stitch_butaquito_inventario_digital/mockups/crear_inventario_butaquito_es/screen.png)

### **Detalle de espacio:** Lista de elementos y botón para adjuntar fotos.

![Detalle de espacio](assets/stitch_butaquito_inventario_digital/mockups/detalle_de_espacio_butaquito_es/screen.png)

### **Resumen de inventario:** Vista previa del inventario.
...
### **Envío:** Modal para envío por correo del inventario.

![Resumen de inventario](assets/stitch_butaquito_inventario_digital/mockups/enviar_inventario_butaquito/screen.png)
